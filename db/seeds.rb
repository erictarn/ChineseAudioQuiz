...
char_array = [
  {:hanzi => "你", :zhuyin_fuhao => "", :pinyin => "nǐ", :english => "you"}, #1
  ...
  {:hanzi => "叫", :zhuyin_fuhao => "", :pinyin => "jiào", :english => "1. call; be called 2. shout 3. order"}, #10
  ...
  {:hanzi => "中", :zhuyin_fuhao => "", :pinyin => "zhōng", :english => "1.among 2. (in the) course 3. hit by"}, #20
  ...
  {:hanzi => "友", :zhuyin_fuhao => "", :pinyin => "yǒu", :english => "friend"}, #30
  ...
  {:hanzi => "國", :zhuyin_fuhao => "", :pinyin => "guó", :english => "country; national"} #37
]
